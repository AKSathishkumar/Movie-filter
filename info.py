...
API_ID = int(environ.get('API_ID', '29281836'))
API_HASH = environ.get('API_HASH', '1418acd2ae807ba19a1aa1ed06565621')
BOT_TOKEN = environ.get('BOT_TOKEN', "6264317755:AAHqpzH-DkaLuI1DNbenEermC5Mb40ZEJUU")
...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '2062413114').split()]
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1001500967172').split()]
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://askasknkl1206:ayyappaak12@cluster0.7et8tqz.mongodb.net/?retryWrites=true&w=majority")
DATABASE_NAME = environ.get('DATABASE_NAME', "Cluster0")
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'moivelinks')
...
FILE_CHANNEL = int(environ.get('FILE_CHANNEL', -1001500967172))
...
# Log Channels
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', -1001542456543))
RQST_LOG_CHANNEL = int(environ.get('RQST_LOG_CHANNEL', -1001542456543))
...
URL_SHORTNER_WEBSITE_API = environ.get('URL_SHORTNER_WEBSITE_API', '703ab07fa720fca950b10df697e845be0867e9eb')
